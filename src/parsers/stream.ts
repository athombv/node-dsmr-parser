...
import { DSMRStreamCallback, EncryptedDSMRStreamParser, DSMRStreamParser as DSMRStreamParserType } from './stream-encrypted.js';
 ...
 */
export const DSMRStreamParser = (stream: Readable, options: Omit<DSMRParserOptions, 'telegram'>, callback: DSMRStreamCallback): DSMRStreamParserType => {
